...
{
    string path = "/Users/redknot/Red3DEngine/3dModel/coat/export3dcoat.obj";
    ...
    for(int i=0;i<scene->mNumMeshes;i++){
        //FILE * pFile = fopen("/Users/redknot/Red3DEngine/3dModel/Tea/Model/part" + intToString(i), "wb");
        aiMesh * paiMesh = scene->mMeshes[i];
        loadMesh(paiMesh,i,"/Users/redknot/Red3DEngine/3dModel/coat/Model/");
    }
